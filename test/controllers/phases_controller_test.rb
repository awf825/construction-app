...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference("Phase.count") do
      post phases_url, params: { phase: { name: @phase.name, project_id: @phase.project_id } }, as: :json
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { name: @phase.name, project_id: @phase.project_id } }, as: :json
    assert_response :success
  end
